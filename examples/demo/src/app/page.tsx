    ...
    const validateAddDevice = async () => {
        try {
            await smartAccount.validateAddDevice({signer:{
                ...
                publicKeyX: "0x6645b3def4604d08a3d6fb583e1a72bd43e18e0cf1dca639b1939245ec9a2d2f",
                publicKeyY: "0x3fdddf5c555997256e56c0f71eb5587353d5d426208b70955e5705995a9b79e8",
            }});
        } catch (e) {
            console.log(e);
        }
