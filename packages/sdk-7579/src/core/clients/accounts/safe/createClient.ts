...
import { smartSessionCreateActions } from "@/core/modules/sessionKey/decorators";
...
>(
    ...
    const client = Object.assign(
        ...
        .extend(smartSessionCreateActions())
        .extend(comethAccountClientActions()) as any;

    return client.extend(safeOwnerPluginActions(parameters.rpcUrl));
}
