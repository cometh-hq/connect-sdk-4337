...
import enableModuleAbi from '../../contracts/abis/safe/enablemodule.json'
import multisendAbi from '../../contracts/abis/safe/multisend.json'
import SafeSingletonAbi from '../../contracts/abis/safe/safe.json'
import Safe4337ModuleAbi from '../../contracts/abis/safe/safe4337ModuleAbi.json'
import SetupModuleSetupAbi from '../../contracts/abis/safe/safeModuleSetup.json'
import SafeProxyFactoryAbi from '../../contracts/abis/safe/safeProxyFactory.json'
import SafeSignerLaunchpadAbi from '../../contracts/abis/safe/safeSignerLaunchpadAbi.json'
import WebAuthnSignerAbi from '../../contracts/abis/safe/safeWebauthnSigner.json'
import WebAuthnSignerFactoryAbi from '../../contracts/abis/safe/safeWebauthnSignerFactory.json'
